...
JAGLINK is C-first. Contributions must preserve the separation between portable diagnostic logic and platform transport/presentation code.
...
```sh
cmake -S . -B build-sanitized -DCMAKE_BUILD_TYPE=Debug -DJAGLINK_ENABLE_SANITIZERS=ON
...
| --- | --- | --- |
| `libjaglink` | C11 | ELM327, OBD-II, scheduler, telemetry, ISO-TP, UDS, manufacturer decoding |
