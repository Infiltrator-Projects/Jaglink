...
static JaglinkIsoTpAddress response_address(void)
{
    JaglinkIsoTpAddress address = {
        ...
        .target_type = JAGLINK_ISOTP_TARGET_FUNCTIONAL,
...
int main(void)
{
    ...
    JaglinkIsoTpCanFrame frame;
    JaglinkIsoTpCanFrame flow_control;
    ...
    require(receiver.state == JAGLINK_ISOTP_RX_RECEIVING,
    ...
    payload = jaglink_isotp_rx_payload(&receiver, &payload_length);
