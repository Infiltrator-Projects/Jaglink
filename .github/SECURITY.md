...
If GitHub private vulnerability reporting is available for this repository, use the repository's **Security** reporting flow. Otherwise, report the issue privately to `infiltratr@yandex.com` with the subject `JAGLINK security report`.
...
JAGLINK is pre-alpha diagnostic software. A successful build or simulated protocol exchange does not prove safe behaviour on a real vehicle. Manufacturer-specific definitions remain unverified until their provenance and real-vehicle behaviour have been established and recorded by the project.
