 ...
 * GResource and registered explicitly before GTK creates any image widgets.
 */
...
/* Generated by glib-compile-resources with --manual-register. Keeping the
 * registration boundary explicit avoids relying on toolchain constructor
 * behaviour and makes packaged/development launches deterministic. */
